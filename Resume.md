...
- 디자인 시스템 모듈 구축 및 Endpoint 패턴 도입 등 코드베이스 구조 개선
- 검색 홈·결과·필터 화면을 SwiftUI + Clean Architecture 기반으로 전면 재구축 (48 PR), Feature Flag 기반으로 배포하여 문제 발생 시 즉시 롤백 가능한 구조로 안전하게 배포
